    ...
    const gdriveFolderBadgeHtml = isGDriveFolder ? `
      <div class="gdrive-badge" title="Google Drive Link">
        <svg viewBox="0 0 100 100" width="100%" height="100%">
          <polygon points="57.5,13.5 91,71.5 74.5,100 41,42" fill="#FFC107" />
          <polygon points="25.5,71.5 74.5,71.5 91,100 9,100" fill="#34A853" />
          <polygon points="41,42 9,100 25.5,71.5 57.5,13.5" fill="#1A73E8" />
        </svg>
      </div>
    ` : '';
