...
DROP POLICY IF EXISTS "Allow company members read adjustments" ON public.supplier_cost_adjustments;
DROP POLICY IF EXISTS "Allow company members insert adjustments" ON public.supplier_cost_adjustments;
DROP POLICY IF EXISTS "Allow company members update adjustments" ON public.supplier_cost_adjustments;
DROP POLICY IF EXISTS "Allow company members delete adjustments" ON public.supplier_cost_adjustments;
