(function() {
  ...
  const sidebarHTML = `
      ...
      <div class="dash-nav-group" id="nav-group-marketing" style="display: none;">
        ...
        <div class="dash-nav-children">
          ...
          <a href="/dashboard/marketing-logs" class="dash-nav-child" data-role="marketing">Logs Tracker</a><a href="/dashboard/media/customers" class="dash-nav-child" data-role="marketing" style="display:flex;justify-content:space-between;align-items:center;"><span>Media</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="opacity:.6;margin-left:.5rem;" title="Shared with other roles"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></a><a href="/dashboard/posting/image-editor" class="dash-nav-child" data-role="marketing" style="display:flex;justify-content:space-between;align-items:center;"><span>Posting</span><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="opacity:.6;margin-left:.5rem;" title="Shared with other roles"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg></a>
        </div>
      </div>
      ...
      <div class="dash-nav-group" id="nav-group-hr" style="display: none;">
        <button class="dash-nav-parent" onclick="toggleSubmenu(this)">
          ...
          <span class="dash-nav-text" style="display:inline-flex; align-items:center; gap:0.35rem;">HR <span id="hr-request-badge-dot" aria-hidden="true" style="display:none; width:6px; height:6px; border-radius:50%; background-color:#ef4444;"></span></span>
          <svg class="dash-nav-chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="6 9 12 15 18 9"/></svg>
        </button>
        <div class="dash-nav-children">
          ...
          <a href="/dashboard/hr-onboarding" class="dash-nav-child" data-role="hr">Onboarding</a>
      ...
      <a href="/dashboard/resources" class="dash-nav-item dash-nav-item-top-level" id="nav-item-resources">
      ...
      <div class="dash-sidebar-footer" style="position: relative;">
        ...
        <div id="user-menu" style="display: none; position: absolute; bottom: calc(100% + 8px); left: 0; right: 0; background: var(--bg-surface); border: 1px solid var(--border); border-radius: var(--radius-md); box-shadow: 0 10px 25px -5px rgba(0,0,0,0.1), 0 8px 10px -6px rgba(0,0,0,0.1); z-index: 100; flex-direction: column; overflow: hidden; padding: 0.35rem 0; animation: popUp 0.15s cubic-bezier(0.16, 1, 0.3, 1) forwards;">
          ...
          <a href="/dashboard/master-settings/tiers" class="dash-nav-item" data-role="master-only" style="border-radius:0; padding: 0.45rem 1rem;">
  ...
  function initSidebar() {
    ...
    const sidebarRouteFamilies = {
      '/dashboard/media/customers': ['/dashboard/media', '/dashboard/media/products'],
      ...
      '/dashboard/sales-goals': [
        '/dashboard/sales-goals',
        '/dashboard/sales-goals/goals',
        '/dashboard/sales-goals/orders',
  ...
  async function initChat() {
    ...
    fab.id = 'chat-fab';
    fab.style.cssText = 'position: fixed; bottom: 0; right: 2rem; border-radius: 6px 6px 0 0; background: var(--cyan, #06b6d4); border: none; box-shadow: 0 -2px 10px rgba(6, 182, 212, 0.3); color: #ffffff; display: flex; align-items: center; justify-content: center; gap: 0.35rem; padding: 0.6rem 1.5rem; font-size: 0.85rem; font-weight: 700; cursor: pointer; z-index: 1000; transition: transform 0.2s, background-color 0.2s; outline: none;';
